 ...
 */
@Autonomous (name = "Red Corner Run")
public class RedCornerRunLM3 extends LinearOpMode
{
    ...
    {  front_left = hardwareMap.dcMotor.get("front_left");
        ...
        Thread.sleep(10000);
        DriveForwardTime(POWER, 1900); //drive forward
        StopMotors();//stop
...
/*
    ...
    */
    ...
    private void StopDrive() throws InterruptedException
    {
        DriveForward(0.0);
    }
